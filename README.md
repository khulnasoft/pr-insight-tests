...
New option for a self-review checkbox is now available for the `/improve` tool, along with the ability(💎) to enable auto-approve, or demand self-review in addition to human reviewer. See more [here](https://pr-assistant-docs.khulnasoft.com/tools/improve/#self-review).

<kbd><img src="https://www.khulnasoft.com/images/pr_assistant/self_review_1.png" width="512"></kbd>
...
Comment: `@KhulnaSoft-Agent /describe --pr_description.publish_description_as_comment=true` to publish the description as a comment in the PR.
`@KhulnaSoft-Agent /review` and `@KhulnaSoft-Agent /improve` should work as-is.
